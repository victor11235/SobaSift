<script>
    ...
    metadata.set({
        title: 'SobaSift | AI Email Management For Academia',
        description: 'SobaSift helps students, professors, and others classify their emails into organized folders. ' +
            'Streamline communications, prioritize responses, and enhance productivity in academic environments.'
    });
</script>

<div>
    <!--HERO-->
    <section class="bg-white dark:bg-gray-900 antialiased min-h-screen">
                ...
                <div class="lg:max-w-xl xl:shrink-0">
                    <div>
                        ...
                        <p class="mt-5 text-base font-normal text-gray-500 dark:text-gray-400 md:max-w-3xl sm:text-xl">
                            Because the only useful emails are the ones you can act on
                        </p>
                    </div>

                    <div class="flex flex-col gap-4 mt-8 sm:flex-row">
                        <a class="sm:w-[182px] px-5 py-3 w-full  text-base font-medium text-center text-white bg-orange-500 rounded-lg shrink-0 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                           href="/auth"
                           title="">
                            Get Started
                        </a>
                        ...
                        <div class="relative h-56 overflow-hidden rounded-lg h-96">
                            <svg class="relative h-56 overflow-hidden rounded-lg h-96"
                                ...
                                <path d="M710.2148,385.89448c3.14447,6.90062,6.15456,15.24071,2.76979,22.62258a12.72387,12.72387,0,0,1-6.516,6.70769c-3.48856,1.39154-7.29105.59741-10.52366-1.0849-6.80615-3.542-11.19315-10.12369-17.2701-14.63276a20.53442,20.53442,0,0,0-9.504-4.0958c-3.9931-.52048-7.95718.42133-11.86275,1.14845-4.15382.77333-8.44682,1.18146-12.29128-.92481a18.04425,18.04425,0,0,1-7.5408-8.61525c-.79169-1.75741-3.37783-.23376-2.59041,1.51416,3.269,7.25667,10.02943,12.20159,18.15233,11.62967,4.298-.30262,8.44935-1.69044,12.75467-1.88923a17.04345,17.04345,0,0,1,10.90314,3.4856c6.67216,4.756,11.20045,12.06,18.85468,15.51434,3.61146,1.62982,7.74711,2.30915,11.55481.9055a15.14759,15.14759,0,0,0,7.73706-6.7377c5.02336-8.64913,1.797-18.64769-2.03711-27.0617-.79947-1.75445-3.38585-.23145-2.59041,1.51416Z"
                                      fill="#2f2e41" transform="translate(-350.95066 -126.7675)"/>
                                <path d="M676.60059,456.17508c-3.30567-.09277-7.4209-.208-10.58985-2.52343a8.13393,8.13393,0,0,1-3.20019-6.07227,5.47021,5.47021,0,0,1,1.86035-4.49316c1.6543-1.39893,4.07129-1.72754,6.67871-.96094l-2.7002-19.72608,1.98243-.27148,3.17285,23.18945-1.6543-.7583c-1.917-.87988-4.55176-1.32861-6.18848.05469a3.51473,3.51473,0,0,0-1.15234,2.895,6.14725,6.14725,0,0,0,2.38086,4.52783c2.4668,1.80176,5.74609,2.03516,9.4668,2.13867Z"
                                      fill="#2f2e41" transform="translate(-350.95066 -126.7675)"/>
                                <rect fill="#2f2e41" height="2" width="10.77148" x="297.12845" y="297.33288"/>
                                <rect fill="#2f2e41" height="2" width="10.77148" x="331.12845" y="297.33288"/>
                                <path d="M630.4559,528.23209l-47.29355-14.42094a6,6,0,0,1-4.06563-7.21509l5.52108-21.75436a6,6,0,0,1,8.39144-3.943l46.90816,22.29692a6.01089,6.01089,0,0,1,3.49516,7.73035l-5.21658,13.8101A6.01071,6.01071,0,0,1,630.4559,528.23209Z"
                                      fill="#2f2e41" transform="translate(-350.95066 -126.7675)"/>
                                <path d="M690.04241,515.92583,710.325,561.0175a6,6,0,0,0,7.67107,3.12113l20.88212-8.22628a6,6,0,0,0,2.85081-8.82249l-28.04671-43.714a6.01089,6.01089,0,0,0-8.11011-2.49011l-13.04,6.92017A6.01071,6.01071,0,0,0,690.04241,515.92583Z"
                                      fill="#2f2e41" transform="translate(-350.95066 -126.7675)"/>
                                <path d="M497.85558,369.39014,358.82286,339.39852l-1.80686-.38885a5.00224,5.00224,0,0,0-5.54552,7.10585L406.67216,458.217a5.0183,5.0183,0,0,0,3.72746,2.72926,4.96825,4.96825,0,0,0,4.37912-1.50154l38.34178-40.42814a2.91036,2.91036,0,0,1,2.13875-.93407,3.01064,3.01064,0,0,1,2.67965,1.558l7.8535,14.52626a4.88621,4.88621,0,0,0,5.47116,2.50722l.03909-.00865a4.893,4.893,0,0,0,3.87711-4.6473l1.57322-33.53178a3.05774,3.05774,0,0,1,.307-1.20476,3.254,3.254,0,0,1,.78832-.97333L499.968,378.15066a5.00564,5.00564,0,0,0-2.11243-8.76052Zm.84922,7.21694-22.11962,18.15759a4.93346,4.93346,0,0,0-.77862.78665,4.64685,4.64685,0,0,0-.53242.83481,4.79649,4.79649,0,0,0-.36273.95079l.00217.00977a4.73079,4.73079,0,0,0-.15751,1.04879l-1.57276,33.53167a2.90448,2.90448,0,0,1-2.32273,2.7876l-.01955.00433a2.91087,2.91087,0,0,1-3.2907-1.49442l-7.85566-14.536a4.98939,4.98939,0,0,0-4.09973-2.60589l-.00954.00211c-.11421-.00536-.228-.01094-.33956-.00675a4.86576,4.86576,0,0,0-2.27209.56424,4.79554,4.79554,0,0,0-1.30551.99549l-38.34133,40.42792a3.00049,3.00049,0,0,1-4.86432-.73653L353.26092,345.22777a3.00779,3.00779,0,0,1,3.32825-4.25969l1.84977.39973,138.98933,29.98084a3.00669,3.00669,0,0,1,1.27653,5.25843Z"
                                      fill="#3f3d56" transform="translate(-350.95066 -126.7675)"/>
                                <path d="M476.25014,395.75022l-.82617,1.8216-.51039-.22513-.00217-.00977L357.76929,344.22l97.81611,71.86487.00954-.00211.259.19874-1.17942,1.61283-1.70078-1.252-96.39341-70.80742a2.00253,2.00253,0,0,1,1.66918-3.56479,1.74378,1.74378,0,0,1,.32206.113l117.235,53.16816Z"
                                      fill="#3f3d56" transform="translate(-350.95066 -126.7675)"/>
                            </svg>
                        </div>
                    </div>
        ...
        <div class="py-8 px-4 mx-auto space-y-12 max-w-screen-xl lg:space-y-20 sm:py-16 lg:px-6">
            ...
            <div class="gap-8 items-center lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Work with
                        tools you already use</h2>
                    <p class="mb-8 font-light lg:text-xl">Create an account. Connect your Microsoft Outlook. Craft
                        an intentional email experience.</p>
                    <!-- List -->
                    <ul class="pt-8 my-7 space-y-5 border-t border-gray-200 dark:border-gray-700">
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">Train a personalized AI model to categorize emails</span>
                        </li>
                        <li class="flex space-x-3">
                            <!-- Icon -->
                            <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500"
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">Free up your inbox</span>
                        </li>
                        <li class="flex space-x-3">
                            <!-- Icon -->
                            <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500"
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">Tackle emails related to specific topics all at once</span>
                        </li>
                    </ul>
                    <p class="mb-8 font-light lg:text-xl">Experience the benefits of having an email organization method
                        that works for you.</p>
                </div>
                <img alt="People working on computers"
                     class="hidden mb-4 w-full lg:mb-0 lg:flex rounded-lg"
                     src="/feature-office-1.png">
            </div>
        </div>
    </section>
            ...
            <div class="mx-auto max-w-screen-md">
                <Accordion flush>
                    <AccordionItem>
                        ...
                        <p class="mb-2 text-gray-500 dark:text-gray-400">Once you connect your Outlook email, you will
                            be asked to create a few folders for relevant topics. Drag 5-10 emails into each of these
                            folders to help train a semi-supervised model on your emails. Once complete, your emails
                            will be organized and all future emails will be categorized based on your pre-trained AI
                            model.</p>
                    </AccordionItem>
                    <AccordionItem>
                        <span slot="header">Where can I see the details?</span>
                        <p class="mb-2 text-gray-500 dark:text-gray-400">Checkout our GitHub Repo <a class="underline"
                                                                                                     href="https://github.com/victor11235/SobaSift">SobaSift</a>
                        </p>
                    </AccordionItem>
                </Accordion>
            </div>
